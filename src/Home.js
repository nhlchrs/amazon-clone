...
function Home() {
    return (
        <div className="home">
            ...
            <Products id={22} title="Nihal" rating={3} price={200} image="https://pbs.twimg.com/media/DdQMfTCX0AAEgje.jpg"/>
            ...
            <Products id={22} title="Nihal" rating={2} price={200} image="https://pbs.twimg.com/media/DdQMfTCX0AAEgje.jpg"/>
